...
import AskAndGetAnswers from "../components/AskAndGetAnswers";
  ...
  return (
    <main id="main-content">
      ...
      <div className="page-grid-bg relative z-0  ">
        <svg
          aria-hidden="true"
          className="grid-pattern-svg absolute inset-0 w-full h-full pointer-events-none -z-10"
        >
          <defs>
            <pattern
              id="grid-pattern"
        ...
        <div className="legacy-wrapper scrollbar-none ">
          <ResourcesPreview />
          <Members />
          <Events />
          <Impact />

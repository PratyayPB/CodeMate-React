...
const AskAndGetAnswers = () => {
  ...
  return (
    <section id="ask-and-get-answers-section" className="flex self-center items-center justify-center w-full max-w-[85vw] mx-auto py-12 sm:px-6 lg:px-8">
      <div className="relative rounded-[2.5rem] bg-[#222222] p-8 sm:p-12 md:p-16 shadow-2xl w-full">
        ...
        <div className="mb-10 max-w-4xl">
          ...
          <p className="font-sans text-sm sm:text-base text-[#999999] mt-4">
            Ask MateBot — built on real student journeys and experiences. Get instant
            insights from our collective intelligence.
          </p>
        </div>
        ...
        <div className="mx-auto rounded-[1.25rem] border border-[#333333] bg-[#2a2a2a] overflow-hidden flex flex-col h-[500px]">
          ...
          <div className="px-5 py-4 flex items-center justify-between border-b border-[#3a3a3a]">
            <div className="flex items-center gap-2">
              ...
              <div className="text-[11px] font-bold text-white tracking-[0.15em] uppercase">
                MATEBOT
              </div>
            </div>
            <div className="flex items-center gap-2">
          ...
          {/* Chat Messages Log */}
          <div ref={chatContainerRef} className="flex-1 overflow-y-auto px-8 py-6 flex flex-col space-y-4">
            {messages.length === 0 ? (
              <div className="flex flex-col mb-4 self-start w-full">
                <div className="mb-2">
                  <span className="text-xs text-[#777777] font-mono font-medium">MateBot \\</span>
                </div>
                <div className="bg-[#3a3a3a] rounded-2xl p-5 max-w-[85%] shadow-sm">
                  <p className="text-white text-base sm:text-lg font-medium leading-relaxed">
                    MateBot online. I am synced with CodeMate's Network. What do you want to know?
                  </p>
                </div>
              </div>
            ) : (
              messages.map((msg, idx) => {
                ...
                return (
                  <div key={idx} className={`flex flex-col w-full ${isAI ? "items-start" : "items-end"}`}>
                    <div className="mb-1">
                      <span className="text-[10px] text-[#777777] font-mono font-medium uppercase">
                        {isAI ? "MateBot \\\\" : "User \\\\"}
                      </span>
                    </div>
                    <div className={`rounded-2xl p-4 max-w-[85%] shadow-sm ${isAI ? "bg-[#3a3a3a] text-white" : "bg-[#f98833] text-black"}`}>
            ...
            {isLoading && (
              <div className="flex flex-col w-full items-start">
                ...
                <div className="bg-[#3a3a3a] rounded-2xl p-4 shadow-sm flex items-center gap-1.5 h-[52px]">
                  <div className="h-1.5 w-1.5 bg-[#888888] rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                  <div className="h-1.5 w-1.5 bg-[#888888] rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                  <div className="h-1.5 w-1.5 bg-[#888888] rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
                </div>
              </div>
            )}
          ...
          <form onSubmit={handleSubmit} className="px-8 pb-8 flex items-center gap-4 border-t border-[#3a3a3a] pt-4 mt-auto bg-[#2a2a2a]">
            <button
              type="button"
